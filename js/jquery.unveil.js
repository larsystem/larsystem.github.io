...
!(function (a) {
	...
	a.fn.unveil = function (f) {
		...
		return (
			r ||
				((r = { images: a(), initialized: !1 }),
				q.container.data(b, r)),
			...
			this.each(function () {
				...
				(r.images = a(r.images).add(this)),
					f.data(b) ||
						(f.data(b, !0),
						f.data(q.attribute) ||
							f.data(q.attribute, f.prop(q.attribute)),
						f
							.one("load" + c, function () {
								var c = a(this);
								c.hasClass(b + "-loaded") ||
